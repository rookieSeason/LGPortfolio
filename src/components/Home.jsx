    ...
    return (
        <div name='home' className='w-screen h-screen bg-[#0a192f] m-0 p-0 overflow-x-hidden'>
                ...
                <div data-aos="fade-up" data-aos-delay="300" data-aos-duration="500" className='whitespace-pre-line sm:max-w-[950px] mx-auto px-8 flex flex-col justify-center h-full z-10'>
                    ...
                    <p className='motion-safe:animate-bounce text-4xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-cyan-200 sm:text-6xl font-bold my-2'>Lester John Gatpolintan</p>
                    <h3 className='animate-typing text-md overflow-hidden whitespace-nowrap text-gray-100 sm:text-3xl'>I'm a Junior Software Developer. </h3>
                    <p className='text-gray-300 max-w-[700px] py-3 text-sm sm:text-lg'>A hardworking Junior Software Developer
