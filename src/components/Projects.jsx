          ...
          <div data-aos='fade-up' data-aos-delay='200' data-aos-duration='500' className='flex flex-col justify-center items-center w-full h-full py-6'>
              ...
              <div className='max-w-[1200px] w-full grid md:grid-cols-3 gap-4 py-3 px-12 mx-12'>
                  <div className='bg-gray-50 dark:bg-gray-800 rounded-xl shadow-xl px-6 py-4 hover:scale-105 duration-300 '>
                      <p className='text-cyan-700 font-semibold dark:text-cyan-400 text-xl text-center'>Online Relocation MIS of HUDRD</p>
                  ...
                  <div className='bg-gray-50 dark:bg-gray-800 rounded-xl shadow-xl px-6 py-4 hover:scale-105 duration-300'>
                      <p className='text-cyan-700 font-semibold dark:text-cyan-400 text-xl text-center'>Student System Basic CRUD Functions</p>
                  ...
                  <div className='bg-gray-50 dark:bg-gray-800 rounded-xl shadow-xl px-6 py-4 hover:scale-105 duration-300'>
                      <p className='text-cyan-700 font-semibold dark:text-cyan-400 text-xl text-center'>React & Node Basic CRUD Web App</p>
